...
class TNW_Salesforce_Helper_Salesforce_Data_Creditmemo extends TNW_Salesforce_Helper_Salesforce_Data
{
    ...
    protected function _queryCreditmemo($_magentoId, $ids)
    {
        $_fields = array(
            ...
            "OriginalOrderId",
            $_magentoId,
            "(SELECT Id, Quantity, UnitPrice, OriginalOrderItemId, PricebookEntry.ProductCode, PricebookEntry.Product2Id, PricebookEntryId, Description, PricebookEntry.UnitPrice, PricebookEntry.Name FROM OrderItems)",
