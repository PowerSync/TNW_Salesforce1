...
abstract class TNW_Salesforce_Model_Sync_Mapping_Invoice_Base_Item extends TNW_Salesforce_Model_Sync_Mapping_Abstract_Base
{
    /**
     * @comment Gets field mapping from Magento and creates Shipment Item object
     * @param Mage_Sales_Model_Order_Invoice_Item $entity
