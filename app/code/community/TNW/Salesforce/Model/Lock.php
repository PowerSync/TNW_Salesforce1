...
/**
 * clone of TNW_Salesforce_Model_Lock, necessary for the old versions compatible
 * Class TNW_Salesforce_Model_Lock
 */
class TNW_Salesforce_Model_Lock
{
    /**
     ...
     *
     * @return TNW_Salesforce_Model_Lock
     */
    ...
    {
        throw new Exception('DB lock not supported by TNW_Salesforce, use the File lock instead');
//
...
//        return false;
    ...
    {
        return (bool) false;// $this->_getLockStorage()->isLockExists($lockName);
    }

    /**
     * Get lock storage model
     *
     * @return TNW_Salesforce_Model_Lock_Storage_Interface
     */
