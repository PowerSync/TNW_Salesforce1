 ...
 *
 * Class TNW_Salesforce_Block_Sales_Order_View_Tab_Salesforce_Form
 */
class TNW_Salesforce_Block_Sales_Order_View_Tab_Salesforce_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        if (Mage::helper('tnw_salesforce')->getOrderObject() == TNW_Salesforce_Model_Config_Objects::ORDER_OBJECT) {
