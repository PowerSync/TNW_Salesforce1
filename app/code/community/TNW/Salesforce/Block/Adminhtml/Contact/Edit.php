...
/**
 * Class TNW_Salesforce_Block_Adminhtml_Contact_Edit
 */
class TNW_Salesforce_Block_Adminhtml_Contact_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        return Mage::registry('salesforce_contact_data');
    }
    ...
    public function getHeaderText()
    {
        if ($this->getContact()->getId()) {
            ...
            return Mage::helper('tnw_salesforce')->__('New Contact Mapping');
        }
    }
}
