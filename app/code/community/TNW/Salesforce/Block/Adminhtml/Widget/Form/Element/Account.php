...
class TNW_Salesforce_Block_Adminhtml_Widget_Form_Element_Account extends Varien_Data_Form_Element_Select
{
    ...
    public function getElementHtml()
    {
        $sfLink = null;
        $value  = $this->getValue();
        $aIdVal = Mage::helper('tnw_salesforce/config')->wrapEmulationWebsiteDifferentConfig($this->getWebsite(), function () use($value, &$sfLink) {
    ...
    public function getAfterElementHtml()
    {
        ...
        $block
            ...
            ->addData(array(
                'url'       => $block->getUrl('*/salesforce_search/account', array('website'=>$this->getWebsite())),
