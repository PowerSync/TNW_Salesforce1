...
class TNW_Salesforce_Block_Adminhtml_Opportunity_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $mageFields = array();
        try {
            $mageFields = Mage::helper('tnw_salesforce/magento')->getMagentoAttributes('Opportunity');
        } catch (Exception $e) {
            $mageFields[] = array(
                'value' => '',
