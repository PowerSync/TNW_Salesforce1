...
class TNW_Salesforce_Block_Adminhtml_Opportunity_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if ($this->getOpportunity()->getId()) {
            return Mage::helper('tnw_salesforce')->__('%s Object Mapping #%s', $this->htmlEscape($this->getOpportunity()->getSfObject()), $this->getOpportunity()->getId());
        } else {
            return Mage::helper('tnw_salesforce')->__('New Opportunity Mapping');
        }
    }
}
