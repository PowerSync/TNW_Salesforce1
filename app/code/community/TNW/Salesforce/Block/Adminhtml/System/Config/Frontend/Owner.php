    ...
    extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $cIdVal = Mage::helper('tnw_salesforce/config')->wrapEmulationWebsiteDifferentConfig($website, function () use($value) {
        ...
        $block = $this->getLayout()
            ...
            ->addData(array(
                ...
                'url'       => $this->getUrl('*/salesforce_search/user', array('website'=>$website->getCode())),
