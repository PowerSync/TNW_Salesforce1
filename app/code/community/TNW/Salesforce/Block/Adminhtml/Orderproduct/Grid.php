...
class TNW_Salesforce_Block_Adminhtml_Orderproduct_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('order_product');
