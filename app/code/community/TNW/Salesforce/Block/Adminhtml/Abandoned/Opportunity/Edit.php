...
class TNW_Salesforce_Block_Adminhtml_Abandoned_Opportunity_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_abandoned_opportunity';
    ...
    public function getHeaderText()
    {
        if ($this->getOpportunity()->getId()) {
            return Mage::helper('tnw_salesforce')->__('%s Abandoned cart Mapping #%s', $this->htmlEscape($this->getOpportunity()->getSfObject()), $this->getOpportunity()->getId());
        } else {
            return Mage::helper('tnw_salesforce')->__('New Abandoned cart Mapping');
        }
    }
}
