...
class TNW_Salesforce_Block_Adminhtml_Abandoned_Opportunity_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
    ...
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('tnw_salesforce/mapping')->getCollection()
            ->addObjectToFilter(TNW_Salesforce_Model_Config_Objects::ABANDONED_OBJECT);
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->setFormFieldName('opportunity');
