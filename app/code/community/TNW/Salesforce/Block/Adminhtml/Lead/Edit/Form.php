...
class TNW_Salesforce_Block_Adminhtml_Lead_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $this->setForm($form);
        $fieldset = $form->addFieldset('lead_map', array('legend' => Mage::helper('tnw_salesforce')->__('Mapping Information')));
        ...
        /* Custom Value */
        $fieldset = $form->addFieldset('lead_map_custom', array('legend' => Mage::helper('tnw_salesforce')->__('Custom Mapping')));
