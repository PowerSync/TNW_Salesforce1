...
class TNW_Salesforce_Adminhtml_Salesforce_Abandoned_OpportunityController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function indexAction()
    {
        $this
            ...
            ->_title($this->__('Abandoned cart Opportunity Field Mapping'));

        $this->_initLayout()
            ->_addContent($this->getLayout()->createBlock('tnw_salesforce/adminhtml_abandoned_opportunity'));
    ...
    public function editAction()
    {
        ...
        if ($model->getId() || $id == 0) {
            ...
            $this->_addContent($this->getLayout()->createBlock('tnw_salesforce/adminhtml_abandoned_opportunity_edit'));
            Mage::helper('tnw_salesforce')->addAdminhtmlVersion('TNW_Salesforce');
            $this->renderLayout();
        } else {
    ...
    public function saveAction()
    {
        if ($data = $this->getRequest()->getPost()) {
            $data['sf_object'] = TNW_Salesforce_Model_Config_Objects::ABANDONED_OBJECT;
