...
class TNW_Salesforce_Adminhtml_Salesforce_OpportunitylineitemController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->_initLayout()
            ->_addContent($this->getLayout()->createBlock('tnw_salesforce/adminhtml_opportunitylineitem'));
