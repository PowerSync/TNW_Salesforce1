...
class TNW_Salesforce_Adminhtml_Salesforce_OrderproductController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        $this->_title($this->__('System'))->_title($this->__('Salesforce API'))->_title($this->__('Ordered Products Mapping'));
        $this->_initLayout()
            ->_addContent($this->getLayout()->createBlock('tnw_salesforce/adminhtml_orderproduct'));
    ...
    public function editAction()
    {
        ...
        if ($model->getId() || $id == 0) {
            ...
            Mage::register('salesforce_order_products_data', $model);
            ...
            $this->_addContent($this->getLayout()->createBlock('tnw_salesforce/adminhtml_orderproduct_edit'));
    ...
    {
        $itemIds = $this->getRequest()->getParam('order_product');
        if (!is_array($itemIds)) {
